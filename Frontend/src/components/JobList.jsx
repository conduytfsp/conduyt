...
export default function JobList({ jobs, totalFilteredJobs, isLoading, currentPage, totalPages, setCurrentPage }) {
                ...
                >
                  ...
                  <div className="mt-6 pt-5 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {skill.name || skill} {/* Handles strings or Objects from backend DTOs */}
                    </span>
                      ))}
