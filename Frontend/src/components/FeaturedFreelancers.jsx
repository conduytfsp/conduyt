...
export default function FeaturedFreelancers() {
    ...
    if (isLoading) return <div className="py-16 text-center text-slate-500 font-medium">Loading talent...</div>;
        ...
        <section className="py-16 bg-[#F8FAFC]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {freelancers.length === 0 ? (
                    <div className="p-12 rounded-3xl border border-slate-200 bg-white text-center max-w-md mx-auto shadow-sm">
                        <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-50 text-[#1798D7]">
                            <Users size={26} />
                        </div>
                        <h3 className="text-base font-extrabold text-slate-900 mb-1">No featured talent yet</h3>
                        <p className="text-xs text-slate-500 mb-6">There are no featured freelancers available right now.</p>
                        <button
                            onClick={() => navigate("/freelancers")}
                            className="px-5 py-2.5 rounded-xl bg-[#1798D7] text-white text-xs font-bold hover:bg-[#1280B8] transition-all cursor-pointer shadow-sm"
                        >
                            Browse All Talent
                        </button>
                    </div>
